BEAM_TEMPLATE = """from dolfin import *
import numpy as np
...
L = {{ length }}
H = {{ height }}
mesh = RectangleMesh(Point(0.0, 0.0), Point(L, H), {{ mesh_nx }}, {{ mesh_ny }})
...
load_density = Constant((0.0, {{ load_density }}))
a = inner(sigma(u), epsilon(v)) * dx
L_form = dot(load_density, v) * dx
